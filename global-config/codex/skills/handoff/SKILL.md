...
description: >
  ...
  remaining work, and context for the next session. Use before clearing context,
  when ending a work session, switching tasks, or when context window is getting
  large. Creates a handoff document in the project's zz_handoffs/ directory.
---
